...
const page = async ({ params }: { params: { gender: string; category: string } }) => {
  ...
  let FilteredProducts =
    category === "all"
      ...
      : Products.filter((prod) => prod.Gender === gender && prod.category === category);
  FilteredProducts = FilteredProducts.sort((a: any, b) => a.category?.localeCompare(b.category));
